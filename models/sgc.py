...
class SGC(nn.Module):
    ...
    def __init__(self, nfeat, nhid, nclass, nlayers=2, dropout=0.5, lr=0.01, weight_decay=5e-4,
            with_relu=True, with_bias=True, with_bn=False, device=None, DM=False):
        ...
        if self.DM == True:
            self.conv2 = GraphConvolution(nfeat, nhid, with_bias=with_bias)
        else:
